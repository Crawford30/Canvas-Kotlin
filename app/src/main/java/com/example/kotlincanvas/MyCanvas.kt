...
class MyCanvas(context: Context) : View(context)  {
    ...
    private val drawColor = ResourcesCompat.getColor(resources, R.color.black_one, null)
    private val backgroundColor = ResourcesCompat.getColor(resources, R.color.white_one, null)
